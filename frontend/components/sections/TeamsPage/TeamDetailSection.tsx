...
export const TeamDetailSection = ({ teamName = "NAMA HMD", onBack, onEdit }: TeamDetailSectionProps) => {
  // Dummy data for players (Indonesian names)
            ...
            <table className="w-full text-center text-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="p-3 bg-white text-gray-500">-</td>
                  <td className="p-3 bg-white text-gray-500">-</td>
                  <td className="p-3 bg-white text-gray-500">-</td>
                  <td className="p-3 bg-white text-gray-500">-</td>
                  <td className="p-3 bg-white text-gray-500">-</td>
